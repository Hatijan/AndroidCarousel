...
public class LoopPageIndicator implements ViewPager.OnPageChangeListener {
    ...
    public LoopPageIndicator(@NonNull Context context, @NonNull LinearLayout containerView, @NonNull ViewPager viewPager, @DrawableRes int drawableRes) {
        if (context == null) {
